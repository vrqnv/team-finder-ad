...
urlpatterns = [
    ...
    path('<int:project_id>/skills/add/', views.AddSkillToProjectView.as_view(), name='add_skill'),
    path('<int:project_id>/skills/<int:skill_id>/remove/', views.RemoveSkillFromProjectView.as_view(), name='remove_skill'),
]