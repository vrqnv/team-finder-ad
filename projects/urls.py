...
urlpatterns = [
    ...
    path('<int:pk>/', views.ProjectDetailView.as_view(),
         name='project_detail'),
    path('<int:pk>/edit/', views.ProjectEditView.as_view(),
         name='project_edit'),
    ...
    path('<int:project_id>/skills/add/', views.AddSkillToProjectView.as_view(),
         name='add_skill'),
    path('<int:project_id>/skills/<int:skill_id>/remove/',
         views.RemoveSkillFromProjectView.as_view(), name='remove_skill'),
]
